...
function createNewId() {
    ...
    const maxId = !todoList.length ? 0 : Math.max.apply(null, todoIdList);
    return maxId + 1;
}
        ...
        return `
         <li class="todo-card">
                    ...
                    <div class="todo-buttons">
                        ...
                        <button class="button delite-button" onclick="handleDeleteClick(event)" value="${todo.id}">삭제</button>
                    </div>
                </li>
                `;
    }).join("");
...
function handleEditClick(e) {
 ...
 <div class="modal" onclick="handleModalBackgroundClick()">
        <div class="modal-eidt-container" onclick="event.stopPropagation()">
            <h3 class="modal-title">TODO 수정하기</h3>
            <div class="input-box">
                <input type="text" class="todo-input" onKeyDown="if(enent.keyCode === 13) document.querySelector('.modal button:nth-of-type(1)').click()">
            </div>
            <div class="todo-buttons">
